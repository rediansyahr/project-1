					...
					<div class="col-md-8">
						...
						<div class="thumbnail">
							<div class="item-inner-blog">
								<?php if($data->gambar!=""){?>
								<a href="<?php echo "".base_url()."Galeri/detail/$data->judul_seo" ?>"><img src="<?php echo ''.base_url().''.$data->gambar.'' ?>"></a>
								<?php } else{}?>
							</div> 
							<div class="blog-property">
							<a href="<?php echo "".base_url()."Galeri/detail/$data->judul_seo" ?>"><h3><?php echo $data->judul; ?></h3></a>
							<i class="fa fa-clock-o"></i> <?php echo $data->tanggal ?> by <b><?php echo $data->nama ?></b>
							<hr>
							<div class="detail_text">
							<?php echo substr($data->isi_galeri,0,300); ?> [...]
							</div>
							<br><br>
							<!--a class="btn btn-primary" href="<?php echo "".base_url()."Galeri/detail/$data->judul_seo" ?>">Read More</a-->
							</div>
						</div>
						<?php } ?>
						<?php echo $paging; ?>
