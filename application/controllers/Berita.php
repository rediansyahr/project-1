...
class Berita extends CI_Controller {
	...
	public function tampil() {
		...
		$data['page'] 				= "berita";
        $config = array();
        $config["base_url"] 		= base_url() . "Berita/tampil/";
        ...
        $data["results"] 			= $this->M_berita->fetch_berita($config["per_page"],$page);
		...
		if(isset($data["results"])){
			$this->template->frontend('berita/home.php',$data);
		}
		else{
	...
	public function detail() {
		...
		$data["results"]			= $this->M_berita->detail_berita($link);
		if(isset($link)){
			$this->template->frontend('berita/detail.php',$data);
		}
		else{
