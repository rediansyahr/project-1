<?php
	class Template {
		...
		function frontend($template = NULL, $data = NULL) {
			if ($template != NULL) {
				// head
				$data['_meta'] 					= $this->_ci->load->view('_layout_frontend/_meta', $data, TRUE);
				$data['_css'] 					= $this->_ci->load->view('_layout_frontend/_css', $data, TRUE);
				
				// Header
				$data['_nav'] 					= $this->_ci->load->view('_layout_frontend/_nav', $data, TRUE);
				$data['_header'] 				= $this->_ci->load->view('_layout_frontend/_header', $data, TRUE);
				
				//Sidebar
				$data['_sidebar'] 				= $this->_ci->load->view('_layout_frontend/_sidebar', $data, TRUE);
				
				//Content
				$data['_headerContent'] 		= $this->_ci->load->view('_layout_frontend/_headerContent', $data, TRUE);
				$data['_mainContent'] 			= $this->_ci->load->view($template, $data, TRUE);
				$data['_content'] 				= $this->_ci->load->view('_layout_frontend/_content', $data, TRUE);
				
				//Footer
				$data['_footer'] 				= $this->_ci->load->view('_layout_frontend/_footer', $data, TRUE);
				
				//JS
				$data['_js'] 					= $this->_ci->load->view('_layout_frontend/_js', $data, TRUE);
